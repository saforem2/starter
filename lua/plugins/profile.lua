return {
    ...
    config = function()
      ...
      require("profile").setup({
        avatar_path = os.getenv("HOME") .. "avatar.png",
        ...
        format = function()
          ...
          comp:text_component_render({
            comp:text_component("git@github.com:saforem2/starter", "center", "ProfileRed"),
            comp:text_component("──── By saforem2", "right", "ProfileBlue"),
          })
